...
const customUrlForm = element                 ("customUrlForm");
const customLabelInput = element                  ("customLabelInput");
const customUrlInput = element                  ("customUrlInput");
const customUrlList = element             ("customUrlList");
...
function customUrlRow(customUrl           )              {
...
function editableCustomUrlRow(customUrl           )              {
...
async function updateCustomUrl(id        , form                 )                {
...
async function deleteCustomUrl(id        )                {
